...
def _load_germline_variants() -> pd.DataFrame:
    df = _load_iarc_csv(GERMLINE_CSV)
    cols = [
...
if __name__ == "__main__":
    ...
    generate_germline_vcf(os.path.join(OUTPUT_DIR, "mock_germline.vcf"))
    generate_somatic_vcf(os.path.join(OUTPUT_DIR, "mock_somatic.vcf"))
    generate_patient_vcf(os.path.join(OUTPUT_DIR, "mock_patient.vcf"))
    print("Done!")
